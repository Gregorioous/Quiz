...
import com.example.quiz.data.data_source.local.QuestionsCacheDB
import com.example.quiz.data.data_source.remote.Services
import com.example.quiz.data.repository.QuestionsRepositoryImpl
import com.example.quiz.data.repository.ScoreRepositoryImpl
import com.example.quiz.domain.repository.QuestionsRepository
import com.example.quiz.domain.repository.ScoreRepository
...
object AppModule {
    ...
    @Provides
    @Singleton
    fun providesServices(client: HttpClient) = Services(client)
